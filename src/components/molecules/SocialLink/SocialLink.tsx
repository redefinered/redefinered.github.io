...
export function SocialLink({ href, label, icon, className }: SocialLinkProps) {
  ...
  return (
    <a
      ...
      className={cn(
        "flex h-9 w-9 items-center justify-center rounded-lg border border-white/10 text-zinc-400 transition-colors hover:border-cyan-500/30 hover:text-cyan-300",
        className,
      )}
    >
